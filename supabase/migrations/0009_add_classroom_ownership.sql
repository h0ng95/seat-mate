...
create index if not exists classrooms_owner_user_created_idx
  on public.classrooms (owner_user_id, created_at desc);
...
revoke all on function public.delete_my_classroom(text) from public, anon;
