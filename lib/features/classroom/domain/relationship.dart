...
extension RelationshipTypeDefinition on RelationshipType {
  ...
  String get energyReading => switch (this) {
    ...
    RelationshipType.emergency => '평소보다 결정적인 순간에 강하게 작동하는 신뢰의 기운이에요.',
  ...
  String get strengthReading => switch (this) {
    ...
    RelationshipType.emergency => '위기나 고민이 생겼을 때 판단이 빨라지고 행동으로 이어지는 관계예요.',
  ...
  String get cautionReading => switch (this) {
    ...
    RelationshipType.emergency => '필요할 때만 찾는 관계처럼 느껴지지 않도록 평소의 안부도 챙겨주세요.',
  ...
  String get adviceReading => switch (this) {
    ...
    RelationshipType.emergency => '별일 없는 날의 짧은 연락이 결정적인 순간의 신뢰를 더 깊게 만들어요.',
